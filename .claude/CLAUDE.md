...
Project-scoped context for Claude Code and AGENTS.md-aware runtimes (Codex,
Kiro, GitLab Duo, etc.). The root `CLAUDE.md` and `AGENTS.md` symlinks both
point here so tools auto-discover this file.
...
All module conventions, version-floor guards, HCL patterns, security rules,
testing strategy, and semver discipline are documented in the skill file:

→ `.claude/skills/terraform/SKILL.md`

Load it (or let Claude Code auto-discover it) before writing or reviewing any
